...
\section{\smash{Sertifikalar}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{\textbf{Savunma Sanayii 401} programını tamamlayarak savunma teknolojileri, sistem mühendisliği, proje yönetimi ve kalite güvencesi alanlarında eğitim aldım.}
      \resumeItemListEnd
