...
\begin{itemize}[leftmargin=0.15in, label={}]
  \small{\item{
    Açık kaynak projelere ve bağımsız geliştirmeye ilgi duyan bir bilgisayar mühendisi. Kendi projelerimi üretmeyi seviyor; kendi kendime öğrenerek kazandığım bu pratik becerileri ve teknik bilgiyi profesyonel iş hayatımda somut sonuçlara dönüştürmeyi hedefliyorum.
  }}
\end{itemize}
...
\section{\smash{Sertifikalar}}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {\href{https://bedirhanyenilmez.com/ssa401.webp}{Savunma Sanayii 401 Sertifikası}}{Şub 2025}
